            ...
            <div className="flex flex-col lg:flex-row justify-between">
                ...
                <form>
                    <div className="flex flex-col">
                        <input type="text" placeholder="Name" className="w-full lg:w-96 2xl:w-128 h-12 border-2 border-gray-300 rounded-md p-2"/>
                        <input type="email" placeholder="Email" className="w-full lg:w-96 2xl:w-128 h-12 border-2 border-gray-300 rounded-md p-2 mt-5"/>
                        <textarea placeholder="Message" className="w-full lg:w-96 2xl:w-128 h-48 border-2 border-gray-300 rounded-md p-2 mt-5"/>
