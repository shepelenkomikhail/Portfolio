...
export const Education: EducationWork[] = [
    ...
    },
    {
        ...
        name: "OLISP “Barsa”",
        place: "Sumy, Ukraine",
        title: "High School | Football Academy",
        description: "I lived in a boarding school with a strict schedule and rules, where I developed fundamental skills and valuable life experiences, such as effective communication, leadership, discipline, and punctuality. Additionally, I gained a strong academic foundation, as well as skills in sports coaching and football playing."
    }
];
